...
interface HifzRangeProps {
    ...
    showActions?: boolean;
    pages?: boolean;
    setActiveRange?: (rangeId: string | number) => void;
    trigger?: string;
}

export const HifzRange: React.FC<HifzRangeProps> = ({
    range,
    filter,
    showActions = false,
    pages = true,
    ...
    const rangeStartAya = (sura: number, page: number): number => {
