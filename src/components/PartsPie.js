...
import { AppRefs, useContextPopup } from "../RefsProvider";
import {
  getHezbByAya,
  getPartFirstAyaId,
  getPartIndexByAyaId,
              ...
              <path
                ...
                onClick={() => {
                  if (activePartIndex !== index) {
                    ...
                    dispatch(gotoAya(history, getPartFirstAyaId(index)));
                    onNavigate();
                  }
                }}
              >
            ...
            <>
              <path
                ...
                className={`hezbQuarterPie ${
                  selectedHezb.absIndex === index + activePartIndex * 8
                    ? "selected"
                    : ""
                }`}
                d={describeArc({
                  ...
                  a2: activePartAngel + (index + 1) * hezbAngel - 0.3,
                })}
                fill="none"
