...
import { addBookmark, deleteBookmark, selectIsBookmarked, selectUser } from "@/store/dbSlice";
import { gotoAya, gotoPage, hideMask, selectEndSelection, selectMaskStart, selectSelectedRange, selectSelectedText, selectStartSelection, startMask } from "@/store/navSlice";
import { AudioState, selectAudioState, selectPlayingAya } from "@/store/playerSlice";
import { AudioRange, selectReciter } from "@/store/settingsSlice";
import { closePopup, hideMenu, selectMenuExpanded, selectPopup, showPopup, showToast, toggleMenu } from "@/store/uiSlice";
import { useIntl, FormattedMessage as Message } from "react-intl";
import { useDispatch, useSelector } from "react-redux";
import { useHistory } from "./useHistory";
import { selectPagesCount, toggleZoom } from "@/store/layoutSlice";
import { copy2Clipboard, keyValues, requestFullScreen, selectTopCommand } from "@/services/utils";
